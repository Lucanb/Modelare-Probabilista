...
#definirea unei distributii alternative
...
#ex2
def estimate_pi(N):
    #generam N puncte aleatorii într-un patrat [0, 1] x [0, 1]
    points = np.random.rand(N, 2)
    #verificam daca fiecare punct este in interiorul cercului de raza 1
